var t,xx,w,ww,markers;app.controller("graphController",function($scope,$http,searchService,$state,$timeout){
	...
	var noo=_.map(t,"no of orders");
	var da= _.map(t,"order fulfilment date");
	...
	console.log(obb);
		...
		var noo=_.map(t,"Component Name");
		var da= _.map(t,"no of orders");
		...
		$scope.myJson2 = {
			    ...
			    {
			      values: [_.countBy(t,"ISO_9001")["1"]],
			      text: "ISO 9001"

			    },
			    
			    {
				      values: [_.countBy(t,"ISO_27000")["1"] +_.countBy(t,"ISO_27001")["1"]
				      
				      +_.countBy(t,"ISO_27002")["1"]+_.countBy(t,"ISO_27003")["1"]
				      
				      +_.countBy(t,"ISO_27004")["1"] 
				      ],
				      
				      text: "ISO 27000 Series"
			    ...
			    {
			      values: [_.countBy(t,"ISO_27033")["1"] +_.countBy(t,"ISO_27034")["1"]],
			      text: "ISO 27033 Series"
			    }, {
			      values: [_.countBy(t,"ISO_15026")["1"] +_.countBy(t,"ISO_15288")["1"] +_.countBy(t,"ISO_15408")["1"]],
			      text: "ISO 15026 Series"

			    },
			    {
				      values: [_.countBy(t,"ISO_18405")["1"]],
				      text: "ISO 18405"

				    },
				  {
					      values: [_.countBy(t,"ISO_21913")["1"]],
					      text: "ISO 21913"
